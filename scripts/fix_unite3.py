...
unite3_new_main = """<main class="flex-1 space-y-8 lg:space-y-12">
            ...
            <div class="columns-1 xl:columns-2 gap-8 space-y-8">
                ...
                <section class="category-yellow note-card p-6 md:p-8 rounded-3xl">
                    ...
                    <ul class="space-y-4 text-slate-800 dark:text-yellow-100 font-medium">
                        ...
                        <li class="bg-white/40 dark:bg-black/10 p-3 rounded-xl"><strong class="text-yellow-800 dark:text-yellow-300 block text-lg mb-1">Sadettin Köpek:</strong> Devletin ünlü veziri ve başmimarıdır. Zazadin Hanı ve Kubadabad Sarayı'nı yapmıştır. Gücünün aşırı artmasından rahatsız olan II. Gıyaseddin Keyhüsrev tarafından öldürtülmüştür.</li>
                        <li class="bg-white/40 dark:bg-black/10 p-3 rounded-xl"><strong class="text-yellow-800 dark:text-yellow-300 block text-lg mb-1">Ahi Evran (Mahmut bin Ahmet el-Hoyi):</strong> Ahilik (esnaf ve zanaatkâr) teşkilatının kurucusudur. Asıl adı Mahmut bin Ahmet el-Hoyi'dir. "Letaif-i Hikmet" adlı eseri yazmıştır.</li>
                        ...
                        <li class="bg-white/40 dark:bg-black/10 p-3 rounded-xl"><strong class="text-yellow-800 dark:text-yellow-300 block text-lg mb-1">Hoca Dehhani:</strong> Divan edebiyatının kurucusu kabul edilir. En ünlü eseri Selçuklu Şehnamesi'dir.</li>
                        <li class="bg-white/40 dark:bg-black/10 p-3 rounded-xl"><strong class="text-yellow-800 dark:text-yellow-300 block text-lg mb-1">Muhyiddin Arabi:</strong> "Şeyh Ekber" lakabıyla bilinir. (Daha sonra Yavuz Sultan Selim mezarını buldurup türbe yaptıracaktır).</li>
                        <li class="bg-white/40 dark:bg-black/10 p-3 rounded-xl"><strong class="text-yellow-800 dark:text-yellow-300 block text-lg mb-1">Alaaddin Siyavuş (Cimri Olayı):</strong> Karamanoğlu Mehmet Bey'in Türkçeyi resmî dil ilan ettiği dönemde (1277), kukla bir hükümdar olarak tahta geçirmeye çalıştığı sahte şehzadedir. Halk ona "Cimri" lakabını takmıştır.</li>
                        <li class="bg-white/40 dark:bg-black/10 p-3 rounded-xl"><strong class="text-yellow-800 dark:text-yellow-300 block text-lg mb-1">Diğer Edebi Şahsiyetler:</strong> Mevlâna (Kebir ve Mesnevi), Hacı Bektaş Veli (Makâlât), Yunus Emre (Risaletü'n Nushiyye), Aşık Paşa (Garipname), Gülşehri (Mantıku't Tayr).</li>
                    </ul>
                </section>
                    ...
                    <div class="space-y-6 text-slate-800 dark:text-cyan-100 font-medium">
                        ...
                        <div class="border-t border-cyan-200 dark:border-cyan-800/50 pt-4">
                            ...
                            <div class="flex flex-col gap-2 text-sm">
                                ...
                                <div class="bg-white dark:bg-slate-800 px-4 py-3 rounded-lg shadow-sm border border-cyan-100 dark:border-cyan-800">
                                    <strong class="text-cyan-700 dark:text-cyan-400 block mb-1">Baba İshak (Babailer) İsyanı (1240):</strong> Türkiye Selçuklu tarihindeki ilk dinî ve sosyal nitelikli büyük Türkmen isyanıdır. Devletin zayıflığını gören Moğollar Anadolu'ya saldırma cesareti bulmuştur.
                                </div>
                                <div class="bg-white dark:bg-slate-800 px-4 py-3 rounded-lg shadow-sm border border-cyan-100 dark:border-cyan-800">
                ...
                <section class="category-orange note-card p-6 md:p-8 rounded-3xl">
                    ...
                    <div class="space-y-4 text-slate-800 dark:text-orange-100 font-medium">
                        ...
                        <div class="border-l-4 border-orange-400 pl-4 py-2 mt-4 bg-orange-50/50 dark:bg-orange-900/20 rounded-r-xl">
                            ...
                            <p class="text-sm">Selçuklu hükümdarları padişah veya sultan anlamında Keyhüsrev, Keykavus, Keykubat gibi Farsça unvanlar kullanmışlardır. Bu, Fars kültürünün yönetimdeki etkisini gösterir.</p>
                        </div>
                    </div>
                </section>
                ...
                <section class="category-red note-card p-6 md:p-8 rounded-3xl">
                    ...
                    <div class="space-y-4 text-slate-800 dark:text-red-100 font-medium">
                        <div class="border-l-4 border-red-400 pl-4 py-2">
                            <strong class="text-red-800 dark:text-red-300 block mb-1">Gevher Nesibe Darüşşifası'nın Özel Durumu:</strong>
                            <p class="text-sm">Bu yapı sadece ilk hastane değil; aynı zamanda Anadolu'nun İslam Dönemi'ne ait en eski şifahanesi ve dünyanın ilk tıp fakültesi olarak kabul edilmektedir.</p>
                        </div>
                        <div class="border-l-4 border-red-400 pl-4 py-2">
                            <strong class="text-red-800 dark:text-red-300 block mb-1">Muinüddin Pervane'nin İkili Politikası:</strong>
                            <p class="text-sm">Kösedağ Savaşı sonrası Moğollar Anadolu'ya geldiğinde, Sinop'ta Pervaneoğullarını kuran Vezir Muinüddin Pervane, Moğollardan yana bir tavır takınmış, ardından gizlice Memlüklerden yardım istemiştir.</p>
                        </div>
                        <div class="border-l-4 border-red-400 pl-4 py-2">
                            <strong class="text-red-800 dark:text-red-300 block mb-1">Ahilik Teşkilatı ve Dini Yapı:</strong>
                            <p class="text-sm">Ahilik teşkilatına kesinlikle gayrimüslimler alınmamıştır. Sadece bir esnaf örgütü değil, gerektiğinde "cihata katılan" silahlı bir yapıdır.</p>
                        </div>
                        <div class="border-l-4 border-red-400 pl-4 py-2">
                            <strong class="text-red-800 dark:text-red-300 block mb-1">Mimari Eser Bulma Şifresi:</strong>
                            <p class="text-sm">İsminde "Paşa, Çelebi, Haseki, Ağa, Sultan, Yeşil" kelimeleri geçiyorsa o eser istisnalar hariç Osmanlı Devleti'ne aittir. İsminde "Çifte" veya "Alaaddin" kelimeleriyle başlayan eserler ise genellikle Anadolu Selçuklu Devleti'ne aittir.</p>
                        </div>
                        <div class="border-l-4 border-red-400 pl-4 py-2">
                            <strong class="text-red-800 dark:text-red-300 block mb-1">Ticaret Stratejisi:</strong>
                            <p class="text-sm">Alanya, Sinop, Antalya, Suğdak gibi liman şehirlerinin fethi, kervansarayların inşası ve gümrük indirimleri tamamen "Anadolu'yu uluslararası bir ticaret merkezi yapmak" amacına yöneliktir.</p>
                        </div>
                    </div>
                </section>
            </div>
                ...
                <div class="relative z-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white/60 hover:bg-white/80 dark:bg-slate-800/60 dark:hover:bg-slate-800/80 transition-colors p-5 rounded-2xl border border-indigo-100 dark:border-indigo-800/50 backdrop-blur-sm relative">
                            ...
                            <p class="text-sm font-medium leading-relaxed mt-2 text-slate-700 dark:text-slate-300">ÖSYM, şıklara çeldirici olarak "Nizamiye Medreseleri"ni koyar. Nizamiye Medreseleri kime aittir?<br><strong class="text-indigo-600 dark:text-indigo-400 mt-2 block text-base">Cevap: Büyük Selçuklu Devleti'ne (Türkiye Selçuklularında yoktur)</strong></p>
                        </div>
                        ...
                        <div class="bg-white/60 hover:bg-white/80 dark:bg-slate-800/60 dark:hover:bg-slate-800/80 transition-colors p-5 rounded-2xl border border-indigo-100 dark:border-indigo-800/50 backdrop-blur-sm relative">
                            ...
                            <p class="text-sm font-medium leading-relaxed mt-2 text-slate-700 dark:text-slate-300">Balıkesir yöresinde Taceddinoğulları kurulmuştur bilgisi yanlış kabul edilmiştir. Balıkesir yöresinde hangi beylik kurulmuştur?<br><strong class="text-indigo-600 dark:text-indigo-400 mt-2 block text-base">Cevap: Karesioğulları</strong></p>
                        </div>
...
content = re.sub(r'<main class="flex-1 space-y-8 lg:space-y-12">.*?</main>', unite3_new_main, content, flags=re.DOTALL)
